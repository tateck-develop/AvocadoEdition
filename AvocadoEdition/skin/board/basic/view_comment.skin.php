...
<section id="bo_vc">
    ...
    <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:rgba(255, 255, 255, .2)"<?php } ?>>
...
<aside id="bo_vc_w">
    ...
    <div class="btn_confirm">
        <button type="submit" id="btn_submit" class="btn_submit btn-design">댓글등록</button>
    </div>
