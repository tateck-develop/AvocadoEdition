	...
	<div class="inner">
		...
		<div id="bo_list">
			...
			<nav  class="board-category">
				<ul>
					<li <?=!$sca == ''? 'class="selected"' : ''?>><a href="./board.php?bo_table=<?=$bo_table?>">ALL</a></li><? echo $category_list ?>
				</ul>
			</nav>
			<?php } ?>
			<!-- } 게시판 카테고리 끝 -->
			...
			<table class="board-list">
				...
				for ($i=0; $i<count($list); $i++) {
				 ?>
				<tr class="bg-<?=$i%2?> <?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
					<td class="td_num">
					<?php
			...
			<div class="bo_fx">
				<?php if ($list_href || $write_href) { ?>
					<?php if ($list_href) { ?><a href="<?php echo $list_href ?>" class="btn-design">목록</a><?php } ?>
					<?php if ($write_href) { ?><a href="<?php echo $write_href ?>" class="btn-design">글쓰기</a><?php } ?>
				<?php } ?>
			</div>
			<?php } ?>
			</form>
